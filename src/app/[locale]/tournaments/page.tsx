...
const SPORT_VARIANTS: Record<string, string> = {
  FUTSAL_5: '5-a-side Futsal',
  FUTSAL_6: '6-a-side Football',
  FUTSAL_7: '7-a-side Football',
  FOOTBALL_FULL: '11-a-side Football',
        ...
        <div className={`relative h-40 shrink-0 overflow-hidden rounded-t-3xl sm:rounded-t-3xl bg-gradient-to-br ${
          ...
          <div className="absolute bottom-4 left-5 right-16">
            <p className="text-[9px] font-black uppercase tracking-widest text-white/50 mb-1">
              {t.formatConfig?.sportVariant ? SPORT_VARIANTS[t.formatConfig.sportVariant] : t.sport} · {t.formatType?.replace(/_/g, ' ')}
            </p>
        ...
        <div className="p-5 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              {
                label: 'Sport',
                value: t.formatConfig?.sportVariant
                  ? SPORT_VARIANTS[t.formatConfig.sportVariant]
                  : t.sport,
              },
            ...
            {filtered.map(t => {
              ...
              return (
                ...
                >
                  ...
                  {/* Footer row */}
                  <div className="flex items-center gap-4 pt-4 border-t border-white/5 text-xs font-bold text-[var(--muted)] flex-wrap">
                    <div className="flex items-center gap-1.5">
                      <Users size={13} />
                      <span>{t._count?.registrations || 0}/{t.maxParticipants}</span>
                    </div>
                    {t.venue && (
