...
export async function POST(request: Request) {
  try {
    ...
    const tournamentData = {
      ...
      formatType,
      groupCount: groupCount ? parseInt(groupCount) : (formatConfig && formatConfig.numberOfGroups ? parseInt(formatConfig.numberOfGroups) : null),
      teamsPerGroup: teamsPerGroup ? parseInt(teamsPerGroup) : (formatConfig && formatConfig.teamsPerGroup ? parseInt(formatConfig.teamsPerGroup) : null),
      qualifyPerGroup: qualifyPerGroup ? parseInt(qualifyPerGroup) : (formatConfig && formatConfig.teamsAdvancePerGroup ? parseInt(formatConfig.teamsAdvancePerGroup) : null),
