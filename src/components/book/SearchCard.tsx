    ...
    <div className="glass rounded-3xl overflow-hidden mb-5 border border-white/5">
      <div className="flex border-b border-white/5">
        ...
        <div className="flex-1 flex items-center gap-2 py-2 px-3 relative">
          ...
          >
             <option value="" className="bg-neutral-900 text-neutral-500">{t('anyTime')}</option>
             <option value="Morning" className="bg-neutral-900">☀️ {t('morning')}</option>
             <option value="Afternoon" className="bg-neutral-900">🌤️ {t('afternoon')}</option>
             <option value="Evening" className="bg-neutral-900">🌅 {t('evening')}</option>
             <option value="Night" className="bg-neutral-900">🌙 {t('night')}</option>
             <optgroup label={t('exactSlots')} className="bg-neutral-950 font-bold uppercase text-[9px] mt-2">
      ...
      <div className="flex flex-col border-b border-white/5">
        <label className="text-[10px] uppercase tracking-widest font-bold text-neutral-500 pt-3 px-4 -mb-1">{t('selectLocation')}</label>
        <div className="flex items-center px-4 py-3">
          ...
          >
             <option value="all" className="bg-neutral-900">{t('allLocations')}</option>
             {cities.map(c => (
