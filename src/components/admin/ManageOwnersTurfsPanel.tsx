...
interface Turf  {
  ...
  createdAt?: string; isCoachProfile?: boolean;
}
...
export default function ManageOwnersTurfsPanel() {
  ...
  const orphaned      = standardTurfs.filter(t => !knownOwnerIds.has(t.ownerId));
    ...
    <div className="flex flex-col gap-5">
      ...
      {subTab === 'owners' && (
        loading ? (
          ...
          <div className="flex flex-col gap-4">
            {standardOwners.length === 0 && orphaned.length === 0 && (
