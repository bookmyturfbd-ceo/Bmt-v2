        ...
        <div className="p-5 flex flex-col gap-4">
          {tab === 'profile' ? (
            <>
              ...
              <div className="mt-2 pt-4 border-t border-[var(--panel-border)]">
                <button onClick={handleSignOut} className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20 text-red-500 text-sm font-black hover:bg-red-500/20 transition-colors">
                  <LogOut size={16} />
                  Sign Out
                </button>
              </div>
